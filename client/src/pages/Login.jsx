...
export const Login = () => {
    ...
    const handleSubmit = async (ev) => {
        ...
        try {
            ...
            if (user) {
                ...
                Cookies.set("user", user.data.user.email, { expires: expirationDate });
                navigate("/annotatorhome", { replace: true })
    ...
    const check = () => {
        ...
        if (Cookies.get("user")) {
            alert("User already logged in. Redirecting now")
            navigate("/annotatorhome", { replace: true })
        }
    }
    useEffect(() => {
        ...
        <div className="bg-gradient-to-r from-[#2c5034] to-[#29b98e] w-full h-screen flex justify-center font-serif items-center">
            <div className="flex bg-white flex-col justify-center w-[25%] px-[2%] py-[2%] rounded-xl ">
                <div className="my-0">
                    ...
                    <h2 className=" text-center  font-bold leading-9 tracking-tight text-gray-900">Sign in as Annotator</h2>
                </div>
                ...
                <div className="mt-[5%] ">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <button type="submit" className="flex w-full justify-center  border-green-700 border-2 bg-white rounded-xl text-[120%] tracking-wider hover:no-underline font-bold text-green-700 hover:bg-green-700 hover:text-white py-7  leading-6  shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
                        </div>
                    </form>
